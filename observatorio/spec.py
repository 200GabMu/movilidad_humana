...
_p("Asistencia Humanitaria", "Asistencia Humanitaria", "asistencia_humanitaria", [
    ...
    Fila([470, 240, 256, 243], [
        Fila([1, 1], [
            ...
            [card("Recuento de OTROS (kit humanitario)", medida=f"count:{OTROS_KIT}"),
...
_p("Cobertura de Kits de Alimentos", "Asistencia Humanitaria", "kits_alimentos", [
    _tarjetas_asistencia("Recuento de OTROS (kit de alimentos)", medida=f"count:{OTROS_KIT}", filtros={OTROS_KIT: _ALIMENTOS}),
    Fila([700, 457], [
        barh("KIT DE ALIMENTOS ZONA", "ZONA", medida=f"count:{OTROS_KIT}", filtros={OTROS_KIT: ["No aplica"]}, alto=430),

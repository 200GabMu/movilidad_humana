...
assert "KIT DE ALIMENTOS" not in r1.df_limpio.columns   # ya no se inventa: la plantilla de referencia no la trae
...
assert r1.stats["columnas_extra"] == [], r1.stats["columnas_extra"]   # exactamente las 82 de la plantilla
